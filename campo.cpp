		...
		if(n==1){
			...
			if(a[m-1][0]!='B'){
				...
				//primeiro elemento da primeira linha a_{11}	
					...
					// m-ésima linha de a_{m2} a a_{(m-1)1}	
					for(int j=1; (j<n-1);j++){
						if(a[m-1][j]!='B'){
							char cont=48;
							if(a[m-1][j-1]=='B') cont++;
					...
					//último elemento da m ésima linha
					if(a[m-1][n-1]!='B'){
						char cont=48;
						if(a[m-2][n-2]=='B')  cont++;
						if(a[m-2][n-1]=='B')  cont++;
				   ...
				   //primeiro elemento da primeira coluna a_{11}	
					...
					// n-ésima coluna de a_{m2} a a_{m(n-1)}	
					for(int i=1; (i<m-1);i++){
						if(a[i][n-1]!='B'){
							char cont=48;
							if(a[i-1][n-1]=='B') cont++;
					...
					//último elemento da n ésima coluna
					if(a[m-1][n-1]!='B'){
						char cont=48;
						if(a[m-2][n-2]=='B')  cont++;
						if(a[m-2][n-1]=='B')  cont++;
